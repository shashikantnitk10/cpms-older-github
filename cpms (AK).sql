...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2017 at 12:41 PM
...
INSERT INTO `cpms_activity` (`activity_cd`, `activity_name`, `activity_typ`) VALUES
...
('ACT019', 'UT Review', 'S'),
('ACT020', 'UT Rework', 'S'),
('ACT021', 'Qualification', 'M'),
('ACT022', 'QA test execution', 'S'),
('ACT023', 'UAT', 'M'),
('ACT024', 'UAT Support - Analyse', 'S'),
('ACT025', 'UAT Support - Bug', 'S'),
('ACT026', 'UAT Support - Changes', 'S'),
('ACT027', 'Documentation', 'M'),
('ACT028', 'Documentation', 'S'),
('ACT029', 'Project Management', 'M'),
('ACT030', 'Project Management', 'S'),
('ACT031', 'Global Management', 'M'),
('ACT032', 'Global Management', 'S');
...
--
-- Dumping data for table `cpms_efforts`
--

INSERT INTO `cpms_efforts` (`efforts_task_id`, `efforts_task_owner`, `efforts_dt`, `efforts_act_effort`) VALUES
(2, 'SKT', '2017-06-06', '4.00');
...
('VH2FLORI', 'V172', 1, 'AKR', 'AKR', 'Sylvie', '2017-06-01', '2017-06-30', '100.00', '0.00', '0.00', '0.00', '0.00'),
('VI1LASSN', 'V181', 1, 'PNL', 'SKT', '', '2017-10-25', '2017-12-12', '200.00', '0.00', '0.00', '0.00', '4.00');
...
CREATE TABLE `cpms_release` (
  ...
  `release_budget_init` decimal(7,0) NOT NULL,
...
INSERT INTO `cpms_release` (`release_cd`, `release_mgr`, `release_start_dt`, `release_end_dt`, `release_budget_init`, `release_status`) VALUES
('V172', 'PNL', '2017-06-01', '2017-11-01', '1000', 'C'),
('V181', 'SKT', '2017-06-27', '2017-06-30', '1200', 'A'),
('V182', 'PNL', '2017-12-09', '2018-08-29', '2222', 'A');
...
CREATE TABLE `cpms_task` (
  ...
  `task_pln_budget` decimal(7,2) NOT NULL DEFAULT '0.00',
  `task_act_budget` decimal(7,2) NOT NULL DEFAULT '0.00',
  `task_nit` decimal(7,2) NOT NULL DEFAULT '0.00',
  `task_ttf` decimal(7,2) NOT NULL DEFAULT '0.00'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'VH2CHUDP', 'C1', 'ACT001', 'ACT002', ' SFDI VH2CHUDP', 'SKT', '2017-06-01', '2017-06-08', NULL, NULL, '4.50', '0.00', '0.00', '0.00'),
(2, 'VH2CHUDP', 'C1', 'ACT001', 'ACT003', ' SFD VH2CHUDP', 'PNL', '2017-06-07', '2017-06-09', NULL, NULL, '1.50', '0.00', '0.00', '0.00'),
(3, 'VH2CHUDP', 'C2', 'ACT005', 'ACT007', 'SMT VH2CHUDP review', 'AKR', '2017-12-31', '2018-01-01', NULL, NULL, '3.25', '0.00', '0.00', '0.00'),
(5, 'VH2CHUDP', 'C2', 'ACT005', 'ACT006', 'test', 'AKR', '2017-12-31', '2018-01-01', NULL, NULL, '2.25', '0.00', '0.00', '0.00'),
(6, 'VH2CHUDP', 'C3', 'ACT001', 'ACT003', 'accept review', 'PNL', '2017-12-31', '2018-01-01', NULL, NULL, '2.25', '0.00', '0.00', '0.00');
...
('AKR', 'Akshay Kapoor', 'AKR', 'A', 'Lead', 'A'),
('PNL', 'Prashant Nainwal', 'PNL', 'A', 'Lead', 'A'),
('SKT', 'Shashi Kant', 'SKT', 'A', 'Lead', 'A');
