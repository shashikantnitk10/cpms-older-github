...
('I101', 'Project presentation', NULL, 'In'),
('I1011', 'Project presentation', 'I101', 'In'),
('I102', 'Acceptance preparation', NULL, 'In'),
('I1021','Acceptance preparation', 'I101', 'In'),
('I106', 'SMT acceptance', NULL, 'In'),
('I1061', 'SMT acceptance', 'I106', 'In'),
('I1062', 'SMT acceptance review','I106', 'In'),
('I1063', 'SMT acceptance rework', 'I106', 'In'),
('I108', 'Doing development sheet', NULL, 'In'),
('I1081', 'Doing development sheet', 'I108', 'In'),
('I1082', 'Doing development sheet review', 'I108', 'In'),
('I1083', 'Doing development sheet rework', 'I108', 'In'),
('I140', 'Param Acceptance', NULL, 'In'),
('I1401', 'Param Acceptance', 'I140', 'In'),
('I300', 'CUT', NULL, 'In'),
('I3001', 'Coding', 'I300', 'In'),
('I3002', 'Coding review', 'I300', 'In'),
('I3003', 'Coding rework', 'I300', 'In'),
('I3004', 'Unit Testing', 'I300', 'In'),
('I3005', 'Unit Testing review', 'I300', 'In'),
('I3006', 'Unit Testing rework', 'I300', 'In'),
('I500', 'Qualification', NULL, 'In'),
('I5001', 'Qualification', 'I500', 'In'),
('I501', 'Qualification defect fixing', NULL, 'In'),
('I5011', 'Qualification defect fixing', 'I501', 'In'),
('I600', 'Pre-intergration (xnet)', NULL, 'In'),
('I6001', 'Pre-intergration (xnet)', 'I600', 'In'),
('I700', 'Acceptance testing (Analyse)', NULL, 'In'),
('I7001', 'Acceptance testing (Analyse)', 'I700', 'In'),
('I701', 'Acceptance testing (Bug)', NULL, 'In'),
('I7011', 'Acceptance testing (Bug)', 'I701', 'In'),
('I702', 'Acceptance testing (changes)', NULL, 'In'),
('I7021', 'Acceptance testing (changes)', 'I702', 'In'),
('I710', 'Documentation', NULL, 'In'),
('I7101', 'Documentation', 'I710', 'In'),
('I130', 'Project Leader', NULL, 'In'),
('I1301', 'Project Leader', 'I130', 'In'),
('F10A', 'Upstream Assistance', NULL, 'Fr'),
('F10T', 'Upstream Other Tasks + Transl.', NULL, 'Fr'),
('F10R', 'Upstream Review', NULL, 'Fr'),
('F14A', 'Param Acceptance Assistance', NULL, 'Fr'),
('F30A', 'CUT Assistance', NULL, 'Fr'),
('F30T', 'CUT Other Tasks + Transl.', NULL, 'Fr'),
('F30R', 'CUT review', NULL, 'Fr'),
('F50A', 'Qualification Assistance', NULL, 'Fr'),
('F50T', 'Qualification Other Tasks + Transl.', NULL, 'Fr'),
('F50R', 'Qualification Review', NULL, 'Fr'),
('F600', 'Pre-intergration (xnet)', NULL, 'Fr'),
('F70A', 'Acceptance testing Assistance', NULL, 'Fr'),
('F70R', 'Acceptance testing Review', NULL, 'Fr'),
('F70T', 'Acceptance testing Other Tasks + Transl.', NULL, 'Fr'),
('F71R', 'Documentation Review', NULL, 'Fr'),
('F130', 'Project Leader', NULL, 'Fr');
...
('VH2CHUDP', 'I1051', 'real', '8.00'),
('VH2CHUDP', 'I1052', 'real', '3.00'),
('VH2CHUDP', 'I1053', 'real', '1.00');
...
(1, 'VH2CHUDP', 'C1', 'I105', 'I1051', ' ', 'SKT', '2017-06-01', '2017-06-08', NULL, NULL, '4', '0', '0', '0'),
(2, 'VH2CHUDP', 'C1', 'I105', 'I1052', ' ', 'PNL', '2017-06-07', '2017-06-09', NULL, NULL, '1', '0', '0', '0');
...
ALTER TABLE `cpms_budget`
  ...
  ADD CONSTRAINT `cpms_budget_ibfk_2` FOREIGN KEY (`budget_activity_cd`) REFERENCES `cpms_activity` (`activity_cd`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
ALTER TABLE `cpms_task`
  ...
  ADD CONSTRAINT `cpms_task_ibfk_2` FOREIGN KEY (`task_activity_cd`) REFERENCES `cpms_activity` (`activity_cd`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `cpms_task_ibfk_3` FOREIGN KEY (`task_name`) REFERENCES `cpms_activity` (`activity_cd`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ...
  ALTER TABLE `cpms_efforts` ADD `efforts_task_ttf` DECIMAL(5,3) NOT NULL DEFAULT'0.0' AFTER `efforts_act_effort`;
